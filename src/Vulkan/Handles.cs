...
namespace Vulkan
{
	public partial class Instance
	{
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyInstance (this.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateDisplayPlaneSurfaceKHR (DisplaySurfaceCreateInfoKhr CreateInfo, AllocationCallbacks Allocator, out SurfaceKhr Surface)
		{
			unsafe {
				...
				fixed (UInt64* ptrSurface = &Surface.m) {
					return Interop.NativeMethods.vkCreateDisplayPlaneSurfaceKHR (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrSurface);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroySurfaceKHR (this.m, surface.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateDebugReportCallbackEXT (DebugReportCallbackCreateInfoExt CreateInfo, AllocationCallbacks Allocator, out DebugReportCallbackExt Callback)
		{
			unsafe {
				...
				fixed (UInt64* ptrCallback = &Callback.m) {
					return Interop.NativeMethods.vkCreateDebugReportCallbackEXT (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrCallback);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyDebugReportCallbackEXT (this.m, callback.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateDevice (DeviceCreateInfo CreateInfo, AllocationCallbacks Allocator, out Device Device)
		{
			unsafe {
				...
				fixed (IntPtr* ptrDevice = &Device.m) {
					return Interop.NativeMethods.vkCreateDevice (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrDevice);
				}
			}
		}
		...
		public Result EnumerateDeviceLayerProperties (out UInt32 PropertyCount, out LayerProperties Properties)
		{
			unsafe {
				fixed (UInt32* ptrPropertyCount = &PropertyCount) {
					...
					return Interop.NativeMethods.vkEnumerateDeviceLayerProperties (this.m, ptrPropertyCount, (IntPtr) Properties.m);
				}
			}
		}
		...
		public Result EnumerateDeviceExtensionProperties (string pLayerName, out UInt32 PropertyCount, out ExtensionProperties Properties)
		{
			unsafe {
				fixed (UInt32* ptrPropertyCount = &PropertyCount) {
					...
					return Interop.NativeMethods.vkEnumerateDeviceExtensionProperties (this.m, pLayerName, ptrPropertyCount, (IntPtr) Properties.m);
				}
			}
		}
		...
		public Result GetDisplayPropertiesKHR (out UInt32 PropertyCount, out DisplayPropertiesKhr Properties)
		{
			unsafe {
				fixed (UInt32* ptrPropertyCount = &PropertyCount) {
					...
					return Interop.NativeMethods.vkGetPhysicalDeviceDisplayPropertiesKHR (this.m, ptrPropertyCount, (IntPtr) Properties.m);
				}
			}
		}
		...
		public Result GetDisplayPlanePropertiesKHR (out UInt32 PropertyCount, out DisplayPlanePropertiesKhr Properties)
		{
			unsafe {
				fixed (UInt32* ptrPropertyCount = &PropertyCount) {
					...
					return Interop.NativeMethods.vkGetPhysicalDeviceDisplayPlanePropertiesKHR (this.m, ptrPropertyCount, (IntPtr) Properties.m);
				}
			}
		}
		...
		public Result GetDisplayModePropertiesKHR (DisplayKhr display, out UInt32 PropertyCount, out DisplayModePropertiesKhr Properties)
		{
			unsafe {
				fixed (UInt32* ptrPropertyCount = &PropertyCount) {
					...
					return Interop.NativeMethods.vkGetDisplayModePropertiesKHR (this.m, display.m, ptrPropertyCount, (IntPtr) Properties.m);
				}
			}
		}
		...
		public Result CreateDisplayModeKHR (DisplayKhr display, DisplayModeCreateInfoKhr CreateInfo, AllocationCallbacks Allocator, out DisplayModeKhr Mode)
		{
			unsafe {
				...
				fixed (UInt64* ptrMode = &Mode.m) {
					return Interop.NativeMethods.vkCreateDisplayModeKHR (this.m, display.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrMode);
				}
			}
		}
	...
	public partial class Device
	{
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyDevice (this.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result AllocateMemory (MemoryAllocateInfo AllocateInfo, AllocationCallbacks Allocator, out DeviceMemory Memory)
		{
			unsafe {
				...
				fixed (UInt64* ptrMemory = &Memory.m) {
					return Interop.NativeMethods.vkAllocateMemory (this.m, AllocateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrMemory);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkFreeMemory (this.m, memory.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateFence (FenceCreateInfo CreateInfo, AllocationCallbacks Allocator, out Fence Fence)
		{
			unsafe {
				...
				fixed (UInt64* ptrFence = &Fence.m) {
					return Interop.NativeMethods.vkCreateFence (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrFence);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyFence (this.m, fence.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateSemaphore (SemaphoreCreateInfo CreateInfo, AllocationCallbacks Allocator, out Semaphore Semaphore)
		{
			unsafe {
				...
				fixed (UInt64* ptrSemaphore = &Semaphore.m) {
					return Interop.NativeMethods.vkCreateSemaphore (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrSemaphore);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroySemaphore (this.m, semaphore.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateEvent (EventCreateInfo CreateInfo, AllocationCallbacks Allocator, out Event Event)
		{
			unsafe {
				...
				fixed (UInt64* ptrEvent = &Event.m) {
					return Interop.NativeMethods.vkCreateEvent (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrEvent);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyEvent (this.m, @event.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateQueryPool (QueryPoolCreateInfo CreateInfo, AllocationCallbacks Allocator, out QueryPool QueryPool)
		{
			unsafe {
				...
				fixed (UInt64* ptrQueryPool = &QueryPool.m) {
					return Interop.NativeMethods.vkCreateQueryPool (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrQueryPool);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyQueryPool (this.m, queryPool.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateBuffer (BufferCreateInfo CreateInfo, AllocationCallbacks Allocator, out Buffer Buffer)
		{
			unsafe {
				...
				fixed (UInt64* ptrBuffer = &Buffer.m) {
					return Interop.NativeMethods.vkCreateBuffer (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrBuffer);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyBuffer (this.m, buffer.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateBufferView (BufferViewCreateInfo CreateInfo, AllocationCallbacks Allocator, out BufferView View)
		{
			unsafe {
				...
				fixed (UInt64* ptrView = &View.m) {
					return Interop.NativeMethods.vkCreateBufferView (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrView);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyBufferView (this.m, bufferView.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateImage (ImageCreateInfo CreateInfo, AllocationCallbacks Allocator, out Image Image)
		{
			unsafe {
				...
				fixed (UInt64* ptrImage = &Image.m) {
					return Interop.NativeMethods.vkCreateImage (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrImage);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyImage (this.m, image.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateImageView (ImageViewCreateInfo CreateInfo, AllocationCallbacks Allocator, out ImageView View)
		{
			unsafe {
				...
				fixed (UInt64* ptrView = &View.m) {
					return Interop.NativeMethods.vkCreateImageView (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrView);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyImageView (this.m, imageView.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateShaderModule (ShaderModuleCreateInfo CreateInfo, AllocationCallbacks Allocator, out ShaderModule ShaderModule)
		{
			unsafe {
				...
				fixed (UInt64* ptrShaderModule = &ShaderModule.m) {
					return Interop.NativeMethods.vkCreateShaderModule (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrShaderModule);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyShaderModule (this.m, shaderModule.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreatePipelineCache (PipelineCacheCreateInfo CreateInfo, AllocationCallbacks Allocator, out PipelineCache PipelineCache)
		{
			unsafe {
				...
				fixed (UInt64* ptrPipelineCache = &PipelineCache.m) {
					return Interop.NativeMethods.vkCreatePipelineCache (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrPipelineCache);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyPipelineCache (this.m, pipelineCache.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateGraphicsPipelines (PipelineCache pipelineCache, UInt32 createInfoCount, GraphicsPipelineCreateInfo CreateInfos, AllocationCallbacks Allocator, out Pipeline Pipelines)
		{
			unsafe {
				...
				fixed (UInt64* ptrPipelines = &Pipelines.m) {
					return Interop.NativeMethods.vkCreateGraphicsPipelines (this.m, pipelineCache.m, createInfoCount, CreateInfos.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrPipelines);
				}
			}
		}
		...
		public Result CreateComputePipelines (PipelineCache pipelineCache, UInt32 createInfoCount, ComputePipelineCreateInfo CreateInfos, AllocationCallbacks Allocator, out Pipeline Pipelines)
		{
			unsafe {
				...
				fixed (UInt64* ptrPipelines = &Pipelines.m) {
					return Interop.NativeMethods.vkCreateComputePipelines (this.m, pipelineCache.m, createInfoCount, CreateInfos.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrPipelines);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyPipeline (this.m, pipeline.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreatePipelineLayout (PipelineLayoutCreateInfo CreateInfo, AllocationCallbacks Allocator, out PipelineLayout PipelineLayout)
		{
			unsafe {
				...
				fixed (UInt64* ptrPipelineLayout = &PipelineLayout.m) {
					return Interop.NativeMethods.vkCreatePipelineLayout (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrPipelineLayout);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyPipelineLayout (this.m, pipelineLayout.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateSampler (SamplerCreateInfo CreateInfo, AllocationCallbacks Allocator, out Sampler Sampler)
		{
			unsafe {
				...
				fixed (UInt64* ptrSampler = &Sampler.m) {
					return Interop.NativeMethods.vkCreateSampler (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrSampler);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroySampler (this.m, sampler.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateDescriptorSetLayout (DescriptorSetLayoutCreateInfo CreateInfo, AllocationCallbacks Allocator, out DescriptorSetLayout SetLayout)
		{
			unsafe {
				...
				fixed (UInt64* ptrSetLayout = &SetLayout.m) {
					return Interop.NativeMethods.vkCreateDescriptorSetLayout (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrSetLayout);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyDescriptorSetLayout (this.m, descriptorSetLayout.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateDescriptorPool (DescriptorPoolCreateInfo CreateInfo, AllocationCallbacks Allocator, out DescriptorPool DescriptorPool)
		{
			unsafe {
				...
				fixed (UInt64* ptrDescriptorPool = &DescriptorPool.m) {
					return Interop.NativeMethods.vkCreateDescriptorPool (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrDescriptorPool);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyDescriptorPool (this.m, descriptorPool.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateFramebuffer (FramebufferCreateInfo CreateInfo, AllocationCallbacks Allocator, out Framebuffer Framebuffer)
		{
			unsafe {
				...
				fixed (UInt64* ptrFramebuffer = &Framebuffer.m) {
					return Interop.NativeMethods.vkCreateFramebuffer (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrFramebuffer);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyFramebuffer (this.m, framebuffer.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateRenderPass (RenderPassCreateInfo CreateInfo, AllocationCallbacks Allocator, out RenderPass RenderPass)
		{
			unsafe {
				...
				fixed (UInt64* ptrRenderPass = &RenderPass.m) {
					return Interop.NativeMethods.vkCreateRenderPass (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrRenderPass);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyRenderPass (this.m, renderPass.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateCommandPool (CommandPoolCreateInfo CreateInfo, AllocationCallbacks Allocator, out CommandPool CommandPool)
		{
			unsafe {
				...
				fixed (UInt64* ptrCommandPool = &CommandPool.m) {
					return Interop.NativeMethods.vkCreateCommandPool (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrCommandPool);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroyCommandPool (this.m, commandPool.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
		...
		public Result CreateSharedSwapchainsKHR (UInt32 swapchainCount, SwapchainCreateInfoKhr CreateInfos, AllocationCallbacks Allocator, out SwapchainKhr Swapchains)
		{
			unsafe {
				...
				fixed (UInt64* ptrSwapchains = &Swapchains.m) {
					return Interop.NativeMethods.vkCreateSharedSwapchainsKHR (this.m, swapchainCount, CreateInfos.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrSwapchains);
				}
			}
		}
		...
		public Result CreateSwapchainKHR (SwapchainCreateInfoKhr CreateInfo, AllocationCallbacks Allocator, out SwapchainKhr Swapchain)
		{
			unsafe {
				...
				fixed (UInt64* ptrSwapchain = &Swapchain.m) {
					return Interop.NativeMethods.vkCreateSwapchainKHR (this.m, CreateInfo.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero, ptrSwapchain);
				}
			}
		}
		...
		{
			unsafe {
				Interop.NativeMethods.vkDestroySwapchainKHR (this.m, swapchain.m, Allocator != null ? (IntPtr) Allocator.m : IntPtr.Zero);
			}
		}
